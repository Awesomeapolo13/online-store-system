...
Обработчики запросов - App\Shared\Application\Command\CommandHandlerInterface
Шина запросов - App\Shared\Application\Command\CommandBusInterface
...
Реализация шин находится на инфраструктурном уровне в неймспейсе `App\Shaed\Infrastructure\Bus`.

## Создание обработчика

Классы конкретных команды и обработчиков создаются в соответствующих модулях.
